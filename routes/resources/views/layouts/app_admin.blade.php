    ...
    <div class="row">
        <div class="container-fluid">
            ...
            <div id="app">
                ...
                <nav class="menu " >
                    <ul>
                    <a href={{url('administrador/users')}} class="fa fa-home"> Inicio </a>  
                    <a href="{{url('administrador/actividad')}}" class="fa fa-sort"> Actividades</a>
                    <a href="{{url('administrador/users')}}" class=" fa fa-group "> Usuarios</a>
                    <a href="{{url('administrador/evaluacion')}}" class="fa fa-file-text-o"> Evaluaciones</a>
                    <a href="{{url('admin/programa')}}" class="fa fa-briefcase"> Programas</a>
                    <a href="{{url('admin/caso')}}" class="fa fa-forward"> Casos</a>
                    <a href="{{url('administrador/Opciones')}}" class="fa  fa-angle-double-down"> Opciones</a>
                </nav>
            </div>
            <main class="py-4">
                @yield('content') 
