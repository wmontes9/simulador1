            ...
            <div class="container-fluid">
                ...
                <div id="app">
                    ...
                    @endguest
                        ...
                        <nav class="menu">
                            <ul>
                            <a class="glyphicon glyphicon-home"  href="{{url('aprendiz')}}" > Inicio </a>  
                            <a href="{{url('descripcion')}}" class="glyphicon glyphicon-list-alt"> Descripción</a>
                            <a href="{{url('audiencia')}}" class="glyphicon glyphicon-grain"> Audiencia</a>
