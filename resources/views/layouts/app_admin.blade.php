        ...
        <div class="row">
            <div class="container-fluid">
                ...
                <div id="app">
                    ...
                    <nav class="menu">
                        <ul>
                            <a href="{{url('administrador/users')}}" class="glyphicon glyphicon-home"> Inicio </a>  
                            <a href="{{url('administrador/actividad')}}" class="glyphicon glyphicon-road"> Actividades</a>
                            <a href="{{url('administrador/users')}}" class="glyphicon glyphicon-user"> Usuarios</a>
                            <a href="{{url('administrador/evaluacion')}}" class="glyphicon glyphicon-file"> Evaluaciones</a>
                            <a href="{{url('admin/programa')}}" class="glyphicon glyphicon-equalizer"> Programas</a>
                            <a href="{{url('admin/caso')}}" class="glyphicon glyphicon-link"> Casos</a>
                            <a href="{{url('administrador/Opciones')}}" class="glyphicon glyphicon-option-vertical"> Opciones</a>
                        </ul>
                    </nav>
                </div>
                <main class="py-4">
